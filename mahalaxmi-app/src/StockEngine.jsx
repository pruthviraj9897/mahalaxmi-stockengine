...
function PartyLedger({ data, persist }) {
  ...
  // Fire window.print() only after the .print-area div has actually
  // committed to the DOM and the browser has had a chance to paint it.
  // (A fixed setTimeout guessed at this timing and printed blank pages
  // on slower mobile browsers where the commit/paint hadn't happened yet.)
  useEffect(() => {
    if (!printMode) return;
    let raf2;
