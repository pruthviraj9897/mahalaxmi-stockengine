...
export default function Login() {
  ...
  const sendCode = async (e) => {
    ...
    if (sendErr) {
      setError(
        sendErr.message?.toLowerCase().includes("signups not allowed") ||
          sendErr.message?.toLowerCase().includes("not found")
          ? "No account found for this email. Ask the admin to add you first."
          : sendErr.message || "Couldn't send the code. Try again."
      );
      return;
    }
      ...
      <div style={styles.card}>
        ...
        {step === "email" && (
          <form onSubmit={sendCode} style={styles.form}>
            <div style={styles.stepLabel}>Sign in with email</div>
